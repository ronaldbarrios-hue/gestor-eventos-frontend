...
export default function QuickActions() {
  ...
  const acciones = [
    ...
    { label: 'Invitar colaborador', icon: Ic('M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z'), run: () => reciente ? navigate(`/eventos/${reciente.id}?s=organizacion&t=equipo`) : navigate('/eventos') },
