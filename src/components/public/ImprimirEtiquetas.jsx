...
import { ETIQUETA } from '../../lib/etiquetaTermica.js';
...
export default function ImprimirEtiquetas({ tickets = [], evento = {}, destacados = [], logoUrl = '', mostrarCodigo = true }) {
  return (
    <>
      ...
      <style>{`
        @media print {
          @page {
            size: ${ETIQUETA.ancho}mm ${ETIQUETA.alto}mm;
            margin: 0;
          }
